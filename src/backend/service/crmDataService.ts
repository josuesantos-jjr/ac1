  ...
  private createTables() {
    const sql = `
      CREATE TABLE IF NOT EXISTS contacts (
        id TEXT PRIMARY KEY,
        chatId TEXT UNIQUE,
        clienteId TEXT, -- Novo campo para identificar o cliente
        nome TEXT,
        sobrenome TEXT,
        telefone TEXT,
        email TEXT,
        ...
        isLeadQualificado INTEGER DEFAULT 0, -- 0 = false, 1 = true
        detalhes_agendamento TEXT, -- JSON string
        resumoParaAtendente TEXT,
        precisaAtendimentoHumano INTEGER DEFAULT 0, -- 0 = false, 1 = true
      ...
      -- Adicionar coluna clienteId se não existir (para migração)
      ALTER TABLE contacts ADD COLUMN clienteId TEXT;
