...
# ac1 git init git add README.md git commit -m primeiro commit git branch -M main git remote add origin https://github.com/josuesantos-jjr/ac1.git git push -u origin main
